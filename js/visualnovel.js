...
const VisualNovel = {
  ...
  OPENING_SCENES: [
    ...
    { bg: 'images/backgrounds/bg_opening.png', speaker: '마스터 이종칠', portrait: 'master', text: '이제 이 도시를 구원할 유일한 희망으로서, 부디 지금 당장 지식의 스파크를 모아 도둑들을 토벌하고 도시의 전원을 켜주시오!' },
  ...
  // ── 배틀 진입 전 결의 대사 ──
  BATTLE_ENTRY: {
    1: [{ speaker: null, portrait: null, isPlayer: true, text: '첫 번째 전기 도둑이군... 가볍게 상대해주지. 덤벼라!' }],
  ...
  VILLAIN_INTRO: {
    1: [
      { speaker: '대기전력 모기', portrait: 'villain_1', text: '윙~♪ 여기 콘센트 맛 좀 봐라! 아무도 안 쓰는 거 내가 쪽쪽 빨아줄게~' },
      { speaker: '대기전력 모기', portrait: 'villain_1', text: '대기전력이 뭔지 알아? 그냥 꽂혀 있기만 해도 전기 먹는다고~ 윙~!' },
    ...
    2: [
      ...
      { speaker: '멀티탭 문어', portrait: 'villain_2', text: '제 촉수 여덟 개가 동시에 쓸 수 있는데, 이 멀티탭 하나로는 아직도 부족하다고요.' },
  ...
  VILLAIN_DEFEAT: {
    1: [
      ...
      { speaker: GameState.nickname, portrait: null, isPlayer: true, text: '대기전력 하나도 모르면서 이 도시 전기를 훔쳐? 이제 꺼져!' },
    ],
    2: [
      { speaker: '멀티탭 문어', portrait: 'villain_2', text: '......인정합니다. 전기 이론에서 제가 졌군요.' },
      { speaker: GameState.nickname, portrait: null, isPlayer: true, text: '지식 없이 쓰는 전기는 도둑질이나 마찬가지예요.' },
    ],
    3: [
      { speaker: '전기도둑 두더지', portrait: 'villain_3', text: '으아아... 회로이론까지 꿰고 있다고?! 이건 좀 억울한데...' },
    ...
    4: [
      ...
      { speaker: '블랙아웃 골렘', portrait: 'villain_4', text: '......이 도시의 빛은... 네가 지켜라.' },
      { speaker: GameState.nickname, portrait: null, isPlayer: true, text: '전기는 지식이 있는 사람이 지켜야 한다. 이 도시의 빛... 이제 내가 지킨다.' },
    ],
  },
